...
fig, (ax1, ax2, ax3, ax4, ax5, ax6) = plt.subplots(nrows=NUM_SUBPLOTS, ncols=1, figsize=(10, NUM_SUBPLOTS * 7))
...
ax5.set_title('Average number of TXs touching the same shared object within an interval')
...
ax6.set_title('Average number of shared objects touched by more than one TX within an interval')
ax6.set_xlabel('Epoch')
ax6.set_ylabel('Avg object touchability')
ax6.minorticks_on()
ax6.legend()
